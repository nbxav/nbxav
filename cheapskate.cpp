...
class newzealand:public cheapskate
{
	public:
		int op;int op1;
		virtual  placeorder()
	...
	virtual orderplaced()
	{
		...
		{
			cout<<"ORDER PLACED IS \n\n";
			cout<<"32' Sony Plasma TV -$400\n400Watts LG Amplifier/AV Receiver -$150\n2-channel Samsung speakers -$50\n";
			cost=(400+150+50);
			cout<<"total cost"<<cost;
		...
		{
			cout<<"ORDER PLACED IS \n\n";
			cout<<"42 Sony LCD TV -$900\n500Watts Kenwood Amplifier/AV Receiver -$300\n5-channel Samsung speakers -$110\n";
			cost=(900+300+120);
			cout<<"total cost"<<cost;
		...
		cost=cost*1.42;
		cout<<"\n\nTOTAL COST IN NEWZEALAND DOLLAR IS:"<<cost;
		cout<<"\n\nEnter Y or N to confirm order:\n";
		cin>>yon;
		switch(yon)
		{
